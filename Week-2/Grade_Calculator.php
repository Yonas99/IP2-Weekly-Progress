...
<body>
    ...
    <form method="post">
        ...
        <div>
            ...
            <input type="number" name="flat" id="flat" required>
        </div>
        <div>
            <label for="os">Operating System</label>
            <input type="number" name="os" id="os" required>
        </div>
        <div>
            <label for="ap">Advanced Programming:</label>
            <input type="number" name="ap" id="ap" required>
        </div>
        <div>
            <label for="sre">Software Requirement Engineering:</label>
            <input type="number" name="sre" id="sre" required>
        </div>
        </fieldset>
        <div>
